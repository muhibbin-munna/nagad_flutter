      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            buildText('Issuer Payment Date Time', nagadResponse.issuerPaymentDateTime),
            buildText('Issuer Payment Ref No', nagadResponse.issuerPaymentRefNo),
            buildText('Additional Merchant Info', nagadResponse.additionalMerchantInfo),
            buildText('Status', nagadResponse.status),
            buildText('Status Code', nagadResponse.statusCode),
            buildText('Cancel Issuer Date Time', nagadResponse.cancelIssuerDateTime),
